...
public func cleanup(sourceDirs: [String]?,
    ...
    let (unusedProtocolMap, usedList) = filterUnusedTypes(annotatedProtocolMap, protocolMap, usedProtocolMap)
    ...
    removeAnnotationsFromUnusedTypes(dirs, exclusionSuffixes, annotation, unusedProtocolMap, concurrencyLimit)
...
public func filterUnusedTypes(_ annotatedProtocolMap: [String: Entry],
